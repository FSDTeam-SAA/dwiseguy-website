                    ...
                    {instruments.map((instrument: Instrument) => {
                        ...
                        return (
                            <div key={instrument._id}>
                                ...
                                <Link href={`/module/${instrument._id}`}>
                                    ...
                                    <div className="flex flex-col cursor-pointer hover:scale-105 transition-transform duration-500 hover:border hover:border-primary hover:border-2 rounded-3xl p-2 bg-white/10 border-primary/50 space-y-4 group">
                                        ...
                                        <div className="px-2">
                                            ...
                                            <p className="text-gray-300 text-sm md:text-base text-white leading-relaxed">
                                                {instrument.instrumentDescription}
                                            </p>
                                            <div className="mt-2 inline-block px-3 py-1 bg-white/10 rounded-full text-xs text-white uppercase tracking-wider text-gray-400">
                                                {instrument.level}
                                            </div>
                                        </div>
                                    </div>
