...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 h-[20px] mb-5 transition-all duration-300 backdrop-blur-md">
      <div className="container mx-auto mt-5 border-b border-rounded rounded-md px-4 sm:px-8 flex justify-between bg-primary/80 items-center py-4">
        {/* Logo */}
        <Link href="/" className="flex items-center">
          <Image src="/images/footerlogo.png" alt="Logo" width={120} height={120} className="cursor-pointer" priority />
        </Link>
