...
const Funsection = () => {
    return (
        ...
        <FeatureSection
            ...
            bgColor="bg-white"
            description="A joyful way to learn piano with structured lessons that turn practice into real progress, making piano learning enjoyable, simple, and rewarding for every level while helping you fall in love with music and build confidence step by step."
            imageSrc="/images/funimage.png"
